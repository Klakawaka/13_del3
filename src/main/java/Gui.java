...
public class Gui {
    public static void main(String[] args) {
        ...
        GUI_Field[] fields = {
                ...
                new GUI_Street("Bukarest" , "Price: 85 $" , "This is the capital of Romania.", "85" , Color.green , Color.black) ,
                new GUI_Street("Brasilia", "Price: 95 $" , "This is the capital of.. you guessed it! Brazil!" , "95" , Color.GREEN , Color.black) ,
                new GUI_Jail() ,
                new GUI_Street("Athen" , "Price: 120 $" , "This is the capital of Greece.", "120" , Color.YELLOW , Color.black) ,
                ...
                new GUI_Chance("?" , "Try ur Luck!" , "You landed on ''?'' This field yield many random possibilities!" , Color.orange, Color.black),
                new GUI_Street("Rome" , "Price: 270 $ " , "This is the capital of Italy." , "270" , Color.darkGray , Color.black),
                new GUI_Street("Dublin" , "Price: 285 $" , "This is the capital of Ireland." , "285" , Color.darkGray , Color.black ),
                new GUI_Jail() ,
