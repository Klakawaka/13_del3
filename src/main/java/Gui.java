...
public class Gui {
    public static void main(String[] args) {
        ...
        GUI_Player player = new GUI_Player("Stephen", 2000); //create and initilize player
        ...
        GUI_Field[] fields = {
                ...
                new GUI_Street("Tripoli", "Price: 65 $", "This is the capital of Lybia. Population: 3.1 Million.", "65", Color.gray, Color.black),
                ...
                new GUI_Street("Copenhagen" , "Price 210 $" , "This is the capital of Denmark. Population: 602 Thousands." , "210" , Color.white , Color.black) ,
                new GUI_Street("Stockholm" , "Price: 220 $" , "This is the capital of Sweden. Population: 975 Thousands. " , "220" , Color.white , Color.black),
                new GUI_Chance("?" , "Try ur Luck!" , "You landed on ''?'' This field yield many random possibilities!" , Color.orange, Color.black),
                new GUI_Street("Rome" , "Price: 270 $ " , "This is the capital of Italy." , "270" , Color.darkGray , Color.white),
                new GUI_Street("Dublin" , "Price: 285 $" , "This is the capital of Ireland. Population: 554 Thousands."  , "285" , Color.darkGray , Color.white),
